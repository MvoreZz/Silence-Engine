...
class LegacyMainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		for (i in 0...optionShit.length)
		{
			...
			menuItem.frames = Paths.getSparrowAtlas('mainmenu/legacy/menu_' + optionShit[i]);
	...
	override function update(elapsed:Float)
	{
		...
		if (!selectedSomethin)
		{
			...
			if (controls.justPressed('debug_1') || (touchPad != null && touchPad.buttonC != null && touchPad.buttonC.justPressed))
			{
				selectedSomethin = true;
